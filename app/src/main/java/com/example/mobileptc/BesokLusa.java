...
public class BesokLusa extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_besok_lusa);
        ...
        txt = findViewById(R.id.textView40);
        txt2 = findViewById(R.id.textView42);
        txt3 = findViewById(R.id.textView43);
        txt4 = findViewById(R.id.textView44);
        txt5 = findViewById(R.id.textView45);
        txt6 = findViewById(R.id.textView46);
        txt7 = findViewById(R.id.textView47w);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BesokLusa.this, Home.class);
    ...
    void kondisiCuaca(int kodeCuaca) {
        ImageView cuaca1 = findViewById(R.id.imageView22);
        if (kodeCuaca == 0) {
